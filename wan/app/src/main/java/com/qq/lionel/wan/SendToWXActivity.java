...
//import com.qq.lionel.wan.uikit.CameraUtil;
//import com.qq.lionel.wan.uikit.MMAlert;
...
public class SendToWXActivity extends Activity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 0x101: {
			final WXAppExtendObject appdata = new WXAppExtendObject();
			final String path = "/mnt/sdcard/tencent/";//CameraUtil.getResultPhotoPath(this, data, SDCARD_ROOT + "/tencent/");
